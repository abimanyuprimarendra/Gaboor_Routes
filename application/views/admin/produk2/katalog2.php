...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(); ?>pemesanan/index">
        ...
        <table class="table">
            ...
            <?php foreach($produk as $item){?>
                                  <tr>
                                    <td width='30'><?php echo $item['paket_id'];?></td>
                                    <td width='200'><?php echo $item['paket_destinasi'];?></td>
                                    <td width='150'><?php echo $item['paket_keterangan'];?></td>
                                    <td width='100'><?php echo $item['paket_harga'];?></td>
